...
#    May 27, 2025 11:29:59 AM CST  platform: Windows NT
...
class MyClassName:
    def __init__(self, top=None):
        ...
        self.bt_example.place(relx=0.067, rely=0.511, height=36, width=167)
        ...
        self.bt_save.place(relx=0.067, rely=0.422, height=26, width=187)
        ...
        self.bt_save.configure(text='''Save as demonstration data''')
        self.bt_save.bind('<ButtonRelease-1>',lambda e:test4_support.on_click_save(e, self))
