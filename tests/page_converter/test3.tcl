...
#  May 27, 2025 08:17:10 AM CST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    text "$top.tex51" \
        ...
        -foreground black -height 54 -highlightbackground #d9d9d9 \
    ...
    vTcl:DefineAlias "$top.tex51" "ed_cel" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$top.ent50" "ed_fah" vTcl:WidgetProc "Toplevel1" 1
    bind $top.ent50 <KeyRelease> {
        lambda e: on_key_fah(e, self)
    }
    button "$top.but47" \
        -activebackground #d9d9d9 -activeforeground black -background #d9d9d9 \
        -command "print("Button clear clicked.")" -disabledforeground #a3a3a3 \
        -font "-family {Segoe UI} -size 9" -foreground #000000 \
        -highlightbackground #d9d9d9 -highlightcolor #000000 -text "Clear" 
    vTcl:DefineAlias "$top.but47" "bt_clear" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $top.lab48 \
        -in $top -x 0 -relx 0.05 -y 0 -rely 0.089 -width 0 -relwidth 0.123 \
        -height 0 -relheight 0.047 -anchor nw -bordermode ignore 
    place $top.tex51 \
        -in $top -x 0 -relx 0.2 -y 0 -rely 0.022 -width 0 -relwidth 0.24 \
        -height 0 -relheight 0.12 -anchor nw -bordermode ignore 
    place $top.ent50 \
        -in $top -x 0 -relx 0.2 -y 0 -rely 0.156 -width 144 -relwidth 0 \
        -height 60 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but47 \
        -in $top -x 0 -relx 0.067 -y 0 -rely 0.356 -width 187 -relwidth 0 \
