...
#    May 26, 2025 03:15:26 PM CST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label1.place(relx=0.014, rely=0.071, height=22, width=52)
        ...
        self.Label2.place(relx=0.014, rely=0.141, height=21, width=71)
        ...
        self.ed_fah.place(relx=0.061, rely=0.127, relheight=0.05, relwidth=0.106)
        ...
        self.ed_fah.bind('<KeyRelease>',lambda e:test1_support.on_key_fah(e, self))

        self.bt_clear = tk.Button(self.top)
        self.bt_clear.place(relx=0.02, rely=0.198, height=26, width=217)
        ...
        self.bt_clear.bind('<ButtonRelease-1>',lambda e:test1_support.on_click_clear(e, self))

        self.ed_cel = tk.Entry(self.top)
        self.ed_cel.place(relx=0.061, rely=0.057, height=40, relwidth=0.105)
        ...
        self.ed_cel.bind('<KeyRelease>',lambda e:test1_support.on_key_cel(e, self))
