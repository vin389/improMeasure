...
proc vTclWindow.top1 {base} {
    ...
    button "$top.but55" \
        ...
        -disabledforeground #a3a3a3 -font "-family {Segoe UI} -size 9" \
        -foreground #000000 -highlightbackground #d9d9d9 \
        -highlightcolor #000000 -text "Save as demonstration data" 
    vTcl:DefineAlias "$top.but55" "bt_save" vTcl:WidgetProc "MyClassName" 1
    ...
    place $top.but54 \
        -in $top -x 0 -relx 0.067 -y 0 -rely 0.511 -width 167 -relwidth 0 \
        -height 36 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but55 \
        -in $top -x 0 -relx 0.067 -y 0 -rely 0.422 -width 187 -relwidth 0 \
