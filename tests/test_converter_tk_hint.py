...
# TkTooltip class is used to create tooltips for widgets in a Tkinter application.
...
# Example usage: 
#   tooltip = TkTooltip(widget, "This is a tooltip text", delay=200)
...
class TempConverterApp:
    def __init__(self, root):
        ...
        TkTooltip(self.ed_cel, "Enter temperature in Celsius.\nF = C * 9 / 5 + 32")
