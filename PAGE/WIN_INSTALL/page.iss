...
[Setup]
    ...
    UsePreviousGroup=1
    AppVersion=8.0
    AppVerName=PAGE - A Python GUI Generator 8.0
    BackColor=$FF0000
    BackColor2=$000000
    ...
    SourceDir=Y:\page-palette\page
    OutputDir=Y:\page-palette
    OutputBaseFilename=page-8.0
    ChangesEnvironment=yes

[Files]
    Source: Y:\page-palette\page\*; DestDir: {app}; Flags: recursesubdirs
