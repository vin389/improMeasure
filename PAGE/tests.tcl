...
#  May 26, 2025 03:09:51 PM CST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 1468x707+25+68
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    vTcl:DefineAlias "$top.ent47" "ed_cel" vTcl:WidgetProc "Toplevel1" 1
    bind $top.ent47 <KeyRelease> {
    ...
    text "$top.tex49" \
        ...
        -selectbackground #d9d9d9 -selectforeground black -width 156 \
        -wrap word 
    $top.tex49 configure -font "TkTextFont"
    $top.tex49 insert end text
    vTcl:DefineAlias "$top.tex49" "ed_fah" vTcl:WidgetProc "Toplevel1" 1
    bind $top.tex49 <KeyRelease> {
    ...
    vTcl:DefineAlias "$top.but51" "bt_clear" vTcl:WidgetProc "Toplevel1" 1
    bind $top.but51 <ButtonRelease-1> {
    ...
    ###################
    place $top.lab48 \
        -in $top -x 0 -relx 0.014 -y 0 -rely 0.071 -width 0 -relwidth 0.036 \
        -height 0 -relheight 0.031 -anchor nw -bordermode ignore 
    place $top.lab50 \
        -in $top -x 0 -relx 0.014 -y 0 -rely 0.141 -width 0 -relwidth 0.049 \
        -height 0 -relheight 0.03 -anchor nw -bordermode ignore 
    place $top.ent47 \
        -in $top -x 0 -relx 0.061 -y 0 -rely 0.057 -width 154 -relwidth 0 \
        -height 40 -relheight 0 -anchor nw -bordermode ignore 
    place $top.tex49 \
        -in $top -x 0 -relx 0.061 -y 0 -rely 0.127 -width 0 -relwidth 0.106 \
        -height 0 -relheight 0.05 -anchor nw -bordermode ignore 
    place $top.but51 \
        -in $top -x 0 -relx 0.02 -y 0 -rely 0.198 -width 217 -relwidth 0 \
